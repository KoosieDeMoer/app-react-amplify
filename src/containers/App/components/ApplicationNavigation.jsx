...
class ApplicationNavigation extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      user:
        window.cache.auth.account !== ""
          ? new User(window.cache.auth.account)
          : null,
  ...
  render() {
    return (
      <nav
        className="navbar sidebar navbar-vertical fixed-left navbar-expand-md navbar-light py-sm-3"
        id="sidenav-main"
        data-v-step="sidebar"
      >
        <button
        ...
        <div className="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <div
            className={
              "sidebar-fade-top" + this.state.scrollbarFadeEnabled
                ? " show"
                : ""
            }
          ></div>
          {/* next was Scrollbar */}
          <div
            options={this.state.scrollbarOptions}
            scrollheight={this.state.scrollbarOptions.height}
                  ...
                  >
                    <li className="nav-item">
                      <div
                        ...
                        data-toggle="collapse"
                        data-target={"#sidebar-item-" + index}
                        role="menuitem"
                      >
                      ...
                      <div
                        ...
                        data-parent={"#sidebar-group-" + index}
                      >
                        <ul className="navbar-nav">
                          {item.children !== undefined
                            ? item.children.map((child, childIndex) => {
                                return child.condition === undefined ||
                                  child.condition() === true ? (
                                  <li
                                    className="nav-item nav-item-child"
                                    key={
                                      "sidebar-item-" + index + "-" + childIndex
                                    }
                                  >
                                    {child.action === undefined ? (
                                      ...
                                      >
                                        ...
                                        <FormattedMessage
                                          id={child.titleTextId}
                                        />
                                      </Link>
                                    ) : (
                                      <div
                                        className="nav-link nav-link-action link-button"
...
class User {
  ...
  hasAbilityTo(ability) {
    return (
      this.role.abilities.find(function (o) {
