        ...
        >
          {this.props.titleTextId && (
            <Modal.Header closeButton={this.props.closeButton}>
              <Modal.Title>
                <FormattedMessage id={this.props.titleTextId} />
              </Modal.Title>
            </Modal.Header>
          )}
          <Modal.Body>
            {this.props.subtitleTextId && (
              <h5>
                <FormattedMessage id={this.props.subtitleTextId} />
              </h5>
            )}
            {this.props.children}
            <hr />
          ...
          <Modal.Footer>
            {this.props.dismissButtonTextId && (
              <Button onClick={this.handleDismiss}>
                <FormattedMessage id={this.props.dismissButtonTextId} />
              </Button>
            )}
            {this.props.confirmButtonTextId && (
              <Button onClick={this.props.handleConfirm} bsstyle="info">
                <FormattedMessage id={this.props.confirmButtonTextId} />
              </Button>
            )}
          </Modal.Footer>
        </Modal>
